...
public class GeumbClusterBlock extends GeumbBlock implements Waterloggable {
    ...
    public GeumbClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
